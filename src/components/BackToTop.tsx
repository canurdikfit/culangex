        ...
        <div className={`fixed bottom-28 md:bottom-20 ${scrollPosition >= 220 ? 'translate-y-0' : 'translate-y-60'} left-5 z-40 transition-transform duration-300 ease-linear`}>
            ...
            >
                <div className="relative">
                    <img src={Back} alt="Back to Top" className="h-16 md:h-20 w-auto object-contain object-center" />
                ...
                <span className="text-[10px] md:text-xs xl:text-sm group-hover:-translate-x-2 transition-transform ease-in-out duration-500">
                    Back to Top
                </span>
            </a>
        </div>
