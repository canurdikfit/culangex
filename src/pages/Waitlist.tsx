    ...
    return (
        <section className='h-[100dvh] w-screen overflow-hidden relative px-6 md:px-12 lg:px-16'>
            ...
            <div className="h-[100dvh] flex items-center justify-center">
                ...
                <img src={Artist} alt="Artist" className="xl:w-[500px] w-[370px] h-auto absolute -bottom-[100px] md:z-20 -right-4" />
                <img src={CyAlt} alt="Artist" className="xl:h-[430px] h-[320px] w-auto absolute bottom-0 right-0 md:z-20" />
                ...
                <div className="relative z-30 flex flex-col items-center w-full opacity-100 scale-100" id="suscribe">
                    <div className="mb-4 md:h-32 md:w-32 h-24 w-24 flex items-center justify-center relative">
                        ...
                        <div id="grow-1" className="absolute h-full w-full scale-[1.5] rounded-full bg-[#D9D9D9] opacity-[4%]" />
                        <div id="grow-2" className="absolute h-full w-full scale-[2.5] rounded-full bg-[#D9D9D9] opacity-[4%]" />
                        <div id="grow-3" className="absolute h-full w-full scale-[3.5] rounded-full bg-[#D9D9D9] opacity-[4%]" />
                    </div>
